...
class EmojiParser(private val params: _root_ide_package_.org.oscar.kb.keyboard.internal.KeyboardParams, private val context: Context) {

    fun parse(): ArrayList<ArrayList<KeyParams>> {
        val emojiArrayId = when (params.mId.mElementId) {
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_RECENTS -> R.array.emoji_recents
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY1 -> R.array.emoji_smileys_emotion
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY2 -> R.array.emoji_people_body
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY3 -> R.array.emoji_animals_nature
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY4 -> R.array.emoji_food_drink
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY5 -> R.array.emoji_travel_places
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY6 -> R.array.emoji_activities
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY7 -> R.array.emoji_objects
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY8 -> R.array.emoji_symbols
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY9 -> R.array.emoji_flags
            _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY10 -> R.array.emoji_emoticons
        ...
        val popupEmojisArray = if (params.mId.mElementId != _root_ide_package_.org.oscar.kb.keyboard.KeyboardId.ELEMENT_EMOJI_CATEGORY2) null
        ...
        val defaultKeyWidth = (_root_ide_package_.org.oscar.kb.latin.utils.ResourceUtils.getDefaultKeyboardWidth(context.resources) - params.mLeftPadding - params.mRightPadding) * params.mDefaultKeyWidth
        val keyWidth = defaultKeyWidth * sqrt(_root_ide_package_.org.oscar.kb.latin.settings.Settings.getInstance().current.mKeyboardHeightScale)
        val defaultKeyboardHeight = _root_ide_package_.org.oscar.kb.latin.utils.ResourceUtils.getDefaultKeyboardHeight(context.resources, false)
        ...
        val emojiKeyboardHeight = _root_ide_package_.org.oscar.kb.latin.utils.ResourceUtils.getDefaultKeyboardHeight(context.resources, false) * 0.75f + params.mVerticalGap - defaultBottomPadding - context.resources.getDimensionPixelSize(R.dimen.config_emoji_category_page_id_height)
        val keyHeight = emojiKeyboardHeight * params.mDefaultRowHeight * _root_ide_package_.org.oscar.kb.latin.settings.Settings.getInstance().current.mKeyboardHeightScale // still apply height scale to key
    ...
    private fun getLabelAndCode(spec: String): Pair<String, Int>? {
        ...
        if ("," !in specAndSdk.first()) {
            ...
            val label = _root_ide_package_.org.oscar.kb.latin.common.StringUtils.newSingleCodePointString(code)
    ...
    private fun parseEmojiKey(spec: String, popupKeysString: String? = null): KeyParams? {
        ...
        return KeyParams(
            ...
            popupKeysSpec,
            _root_ide_package_.org.oscar.kb.keyboard.Key.LABEL_FLAGS_FONT_NORMAL,
            params
        )
    }
}

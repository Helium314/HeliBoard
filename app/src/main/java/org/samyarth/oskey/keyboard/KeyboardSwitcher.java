...
import org.samyarth.oskey.keyboard.KeyboardLayoutSet.KeyboardLayoutSetException;
import org.samyarth.oskey.keyboard.clipboard.ClipboardHistoryView;
import org.samyarth.oskey.keyboard.emoji.EmojiPalettesView;
import org.samyarth.oskey.keyboard.internal.KeyboardState;
import org.samyarth.oskey.latin.InputView;
import org.samyarth.oskey.latin.KeyboardWrapperView;
...
import org.samyarth.oskey.latin.utils.CapsModeUtils;
import org.samyarth.oskey.latin.utils.LanguageOnSpacebarUtils;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void loadKeyboard(final EditorInfo editorInfo, final SettingsValues settingsValues,
        ...
        final org.samyarth.oskey.keyboard.KeyboardLayoutSet.Builder builder = new org.samyarth.oskey.keyboard.KeyboardLayoutSet.Builder(
    ...
    private void setKeyboard(final int keyboardId, @NonNull final KeyboardSwitchState toggleState) {
        ...
        final org.samyarth.oskey.keyboard.MainKeyboardView keyboardView = mKeyboardView;
    ...
    public void setNumpadKeyboard() {
        ...
        setKeyboard(org.samyarth.oskey.keyboard.KeyboardId.ELEMENT_NUMPAD, KeyboardSwitchState.OTHER);
    }
    ...
    public KeyboardSwitchState getKeyboardSwitchState() {
        ...
        } else if (isShowingKeyboardId(org.samyarth.oskey.keyboard.KeyboardId.ELEMENT_SYMBOLS_SHIFTED)) {
    ...
    public void startDoubleTapShiftKeyTimer() {
        ...
        final org.samyarth.oskey.keyboard.MainKeyboardView keyboardView = getMainKeyboardView();

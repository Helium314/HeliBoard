...
import org.samyarth.oskey.keyboard.internal.keyboard_parser.floris.PopupSet;
...
import org.samyarth.oskey.latin.utils.PopupKeysUtilsKt;
...
public class Key implements Comparable<Key> {
    ...
    private static boolean needsToUpcase(final int labelFlags, final int keyboardElementId) {
        ...
        return switch (keyboardElementId) {
            case org.samyarth.oskey.keyboard.KeyboardId.ELEMENT_ALPHABET_MANUAL_SHIFTED, org.samyarth.oskey.keyboard.KeyboardId.ELEMENT_ALPHABET_AUTOMATIC_SHIFTED,
                 org.samyarth.oskey.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCKED, org.samyarth.oskey.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED -> true;
            default -> false;
        };
    }

...
public final class KeySpecParser {
    ...
    private static boolean hasCode(@NonNull final String keySpec, final int labelEnd) {
        ...
        if (keySpec.startsWith(org.samyarth.oskey.keyboard.internal.KeyboardCodesSet.PREFIX_CODE, labelEnd + 1)) {
            return true;
        }
    ...
    public static int parseCode(@Nullable final String text, final int defaultCode) {
        ...
        if (text.startsWith(org.samyarth.oskey.keyboard.internal.KeyboardCodesSet.PREFIX_CODE)) {
            return org.samyarth.oskey.keyboard.internal.KeyboardCodesSet.getCode(text.substring(org.samyarth.oskey.keyboard.internal.KeyboardCodesSet.PREFIX_CODE.length()));
        }
        // This is a workaround to have a key that has a supplementary code point. We can't put a
        // string in resource as a XML entity of a supplementary code point or a surrogate pair.

...
import org.samyarth.oskey.compat.ClipboardManagerCompat
...
import org.samyarth.oskey.latin.common.isValidNumber
...
class ClipboardHistoryManager(
    ...
    fun getClipboardSuggestionView(editorInfo: EditorInfo?, parent: ViewGroup?): View? {
        ...
        closeButton.setImageDrawable(latinIME.mKeyboardSwitcher.keyboard.mIconsSet.getIconDrawable(
            ToolbarKey.CLOSE_HISTORY.name.lowercase()))

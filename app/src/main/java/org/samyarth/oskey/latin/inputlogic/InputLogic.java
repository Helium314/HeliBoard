...
package org.samyarth.oskey.latin.inputlogic;
...
import org.samyarth.oskey.latin.common.SuggestionSpanUtilsKt;
...
import org.samyarth.oskey.latin.DictionaryFacilitator;
import org.samyarth.oskey.latin.LastComposedWord;
...
public final class InputLogic {
     ...
     *                           {@link org.samyarth.oskey.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    private void handleFunctionalEvent(final Event event, final InputTransaction inputTransaction,
        ...
        switch (event.getMKeyCode()) {
            ...
            case KeyCode.CAPS_LOCK, KeyCode.SYMBOL_ALPHA, KeyCode.ALPHA, KeyCode.SYMBOL,
                 KeyCode.NUMPAD, KeyCode.EMOJI,
                 KeyCode.START_ONE_HANDED_MODE, KeyCode.STOP_ONE_HANDED_MODE,
...
//    }
    ...
    /**
     * Make a {@link org.samyarth.oskey.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link org.samyarth.oskey.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *SuggestedWordInfo, org.samyarth.oskey.latin.SuggestedWords)}.
     *
    ...
    public void onUpdateTailBatchInputCompleted(final SettingsValues settingsValues,
        ...
        mConnection.beginBatchEdit();
        if (org.samyarth.oskey.latin.inputlogic.SpaceState.PHANTOM == mSpaceState) {
            insertAutomaticSpaceIfOptionsAndTextAllow(settingsValues);
        }

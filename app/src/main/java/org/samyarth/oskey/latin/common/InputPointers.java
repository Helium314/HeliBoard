...
public final class InputPointers {
    ...
    /**
     * Append the times, x-coordinates and y-coordinates in the specified {@link org.samyarth.oskey.latin.common.ResizableIntArray}
     * to the end of this.
     *
     * @param pointerId    the pointer id of the source.
     * @param times        the source {@link org.samyarth.oskey.latin.common.ResizableIntArray} to read the event times from.
     * @param xCoordinates the source {@link org.samyarth.oskey.latin.common.ResizableIntArray} to read the x-coordinates from.
     * @param yCoordinates the source {@link org.samyarth.oskey.latin.common.ResizableIntArray} to read the y-coordinates from.

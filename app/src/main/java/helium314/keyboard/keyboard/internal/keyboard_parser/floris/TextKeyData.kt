...
sealed interface KeyData : AbstractKeyData {
    ...
    companion object {
        ...
        fun processLabel(label: String, params: KeyboardParams): String = when (label) {
            ...
            KeyLabel.SEND_INTENT_ONE -> "!code/${KeyCode.SEND_INTENT_ONE}"
            KeyLabel.SEND_INTENT_TWO -> "!code/${KeyCode.SEND_INTENT_TWO}"
            KeyLabel.SEND_INTENT_THREE -> "!code/${KeyCode.SEND_INTENT_THREE}"
            else -> {

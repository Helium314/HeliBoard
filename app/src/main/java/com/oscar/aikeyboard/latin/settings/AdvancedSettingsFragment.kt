...
import com.oscar.aikeyboard.latin.utils.ChecksumCalculator
import com.oscar.aikeyboard.keyboard.KeyboardLayoutSet
import com.oscar.aikeyboard.keyboard.KeyboardSwitcher
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_NUMBER
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_NUMPAD
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_NUMPAD_LANDSCAPE
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_PHONE
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_PHONE_SYMBOLS
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_SYMBOLS
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_SYMBOLS_ARABIC
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.LAYOUT_SYMBOLS_SHIFTED
...
import com.oscar.aikeyboard.latin.SystemBroadcastReceiver
import com.oscar.aikeyboard.latin.checkVersionUpgrade
...
import com.oscar.aikeyboard.latin.settings.SeekBarDialogPreference.ValueProxy
import com.oscar.aikeyboard.latin.utils.AdditionalSubtypeUtils
import com.oscar.aikeyboard.latin.utils.CUSTOM_FUNCTIONAL_LAYOUT_NORMAL
import com.oscar.aikeyboard.latin.utils.CUSTOM_FUNCTIONAL_LAYOUT_SYMBOLS
import com.oscar.aikeyboard.latin.utils.CUSTOM_FUNCTIONAL_LAYOUT_SYMBOLS_SHIFTED
...
import com.oscar.aikeyboard.latin.utils.editCustomLayout
import com.oscar.aikeyboard.latin.utils.getCustomLayoutFiles
import com.oscar.aikeyboard.latin.utils.getStringResourceOrName
import com.oscar.aikeyboard.latin.utils.infoDialog
import com.oscar.aikeyboard.latin.utils.reloadEnabledSubtypes
import com.oscar.aikeyboard.latin.utils.updateAdditionalSubtypes
import java.io.File

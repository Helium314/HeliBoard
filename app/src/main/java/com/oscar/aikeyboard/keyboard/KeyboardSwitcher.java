...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void loadKeyboard(final EditorInfo editorInfo, final SettingsValues settingsValues,
        ...
        final com.oscar.aikeyboard.keyboard.KeyboardLayoutSet.Builder builder = new com.oscar.aikeyboard.keyboard.KeyboardLayoutSet.Builder(
    ...
    private void setKeyboard(final int keyboardId, @NonNull final KeyboardSwitchState toggleState) {
        ...
        final com.oscar.aikeyboard.keyboard.MainKeyboardView keyboardView = mKeyboardView;
    ...
    public void setNumpadKeyboard() {
        ...
        setKeyboard(com.oscar.aikeyboard.keyboard.KeyboardId.ELEMENT_NUMPAD, KeyboardSwitchState.OTHER);
    }
    ...
    public KeyboardSwitchState getKeyboardSwitchState() {
        ...
        } else if (isShowingKeyboardId(com.oscar.aikeyboard.keyboard.KeyboardId.ELEMENT_SYMBOLS_SHIFTED)) {

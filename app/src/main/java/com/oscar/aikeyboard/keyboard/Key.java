...
import com.oscar.aikeyboard.keyboard.internal.KeyVisualAttributes;
...
import com.oscar.aikeyboard.keyboard.internal.keyboard_parser.floris.PopupSet;
...
public class Key implements Comparable<Key> {
    ...
    private static boolean needsToUpcase(final int labelFlags, final int keyboardElementId) {
        ...
        return switch (keyboardElementId) {
            case com.oscar.aikeyboard.keyboard.KeyboardId.ELEMENT_ALPHABET_MANUAL_SHIFTED, com.oscar.aikeyboard.keyboard.KeyboardId.ELEMENT_ALPHABET_AUTOMATIC_SHIFTED,
                 com.oscar.aikeyboard.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCKED, com.oscar.aikeyboard.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED -> true;
            default -> false;
        };
    }
